...
# it's just data that professor sturrock made beforehand
# looks like its just a set of random lat-longs
...
ETH_malaria_data_train <- ETH_malaria_data[-validation_rows,] # training sets
ETH_malaria_data_valid <- ETH_malaria_data[validation_rows,] # validation, will predict these using training sets
